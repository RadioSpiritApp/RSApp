(function ($) {
    ...
    function setAppStoreDownloadLink() {
      var userAgent = navigator.userAgent || navigator.vendor || window.opera;

      var newUrl = "#download_page";

      if (/android/i.test(userAgent)) {
          newUrl = "https://play.google.com/store/apps/details?id=com.radiospirits&hl=en_US";
      }

      // iOS detection from: http://stackoverflow.com/a/9039885/177710
      if (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) {
        newUrl = "https://apps.apple.com/us/app/radio-spirits/id389211220";
      }

      // loop over all buttons (with class downloadbutton) and set their href link to iphone or android app store
